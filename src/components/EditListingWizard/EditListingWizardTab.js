...
import {
  ...
  EditListingHouseRulesPanel,
  EditListingLeasePanel,
} from '../../components';
...
export const HOUSERULES = 'houserules';
...
const EditListingWizardTab = props => {
  ...
  switch (tab) {
    ...
    case HOUSERULES: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditListingWizard.saveNewHouseRules'
        : 'EditListingWizard.saveEditHouseRules';
      return (
        <EditListingHouseRulesPanel
          {...panelProps(HOUSERULES)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
          onSubmit={values => {
            onCompleteEditListingWizardTab(tab, values);
          }}
